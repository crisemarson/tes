...
<!-- ------------------------------------------------------------------------------------------------------------------------------- -->
                                        ...
                                        <div class="card profile-card">
                                            ...
                                            <div class="profile-footer">
                                                ...
                                                <ul>
                                                    <li>
                                                        <span>ID number</span>
                                                        <span><?php echo $row['identitynumber'];?></span>
                                                    </li>
                                                    <li>
                                                        <span>Username</span>
 ...
 <!-- ------------------------------------------------------------------------------------------------------------------------------- -->
    <?php
        ...
        $id=$_SESSION['id'];
        $update ="UPDATE `users` SET identitynumber='".$_POST['identitynumber']."', username='".$_POST['username']."', name='".$_POST['name']."', lastname='".$_POST['lastname']."', password='".$_POST['password']."', image='".$post_image."'  where id='".$id."'";

        header("Location: http://localhost/tes/pages/dean/profile.php");
                                            ...
                                            <div class="body">
                                                    ...
                                                    <div class="row clearfix">
                                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                                            <label for="email_address_2">Employee's ID</label>
                                                        </div>
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <input type="text"class="form-control" name="identitynumber" placeholder="" value="<?= $row['identitynumber'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
